...
They are measured by it everywhere.

## Reframe

This is why the goal has to be worthy before it travels.

A bad goal can multiply.

A good goal can multiply too.

If the goal is communication, more people may learn to wait.

If the goal is access, more rooms may change.

If the goal is safety, more adults may ask what pressure is present before they punish the signal.

The goal leaves the room.

So the goal must be chosen with care.

## Move

Pick one goal that follows you across rooms.

Ask:

> What happens when this goal travels?

Does it create more access?
