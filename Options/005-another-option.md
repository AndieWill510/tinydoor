...
We are told that support is optional, accommodations are special treatment, and exhaustion is proof we are not resilient enough.

Then, when we start to break down, people act surprised.

This book does not begin from the belief that Autistic people are broken.
...
Another option is not a slogan.
...
It means the first story may not be the whole story.
