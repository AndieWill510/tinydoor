...
Sometimes the available word is too small. Ableism may be true. Discrimination may be true. Patriarchy or colonialism may be true. But the room may still be missing the specific shape of the harm.

A word can be a handle. Not the whole door. A handle: something the hand can find when the room keeps pretending the door is not there.
...
For this book, one handle is ableism: the pressure to make us less visible, less disruptive, less believed, less accommodated, less ourselves.

The word is not a weapon for winning every argument. It is a handle for noticing the pattern before the pattern becomes your self-blame.

## Move

Pick one situation that keeps getting explained away. Ask:
