...
Autistic burnout can be treated as a personal stamina problem.
...
Not enough positive thinking.

So the person tries harder inside the same conditions that are burning them down.
...
More recovery stolen from sleep.

More pretending the body has not already sent the warning.
...
Support may include values work.

Support may include body-based care, emotional regulation skills, medical care, accommodation, community, food, sleep, money, housing, and fewer punishing rooms.

No single door has to be the whole cure.

The tiny door is the first reduction in fire.
...
Pick one fire you can reduce by one notch.
...
A conversation that always costs too much.
...
With no explanation until after recovery.

Choose one reduction.

## Mercy

You do not have to heal inside the same fire that burned you.
