...
When stress climbs, options disappear in a specific order: first the creative ones, then the ones that require language, then the ones that require believing anyone will help. By the time the body is flooded, the person may still technically have choices, but none of them feel reachable.

This is why people say things afterward that make no sense from the outside. Why didn't you just leave? Why didn't you call? Why didn't you ask for help? Maybe the door existed. But under stress, it locked.
