...
# Option 4.17
# Ask Why the Room Needs This to Stop
...
Sometimes the next question should not be:

> How do we stop the behavior?

Sometimes the next question should be:

> Why does the room need this to stop?
...
When someone wants a behavior stopped, ask one quieter question first:
